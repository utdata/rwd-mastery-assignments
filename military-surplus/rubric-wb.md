...
- Which departments have received the most equipment by value in the state?
  - You have to create a calculation to get this value. It is the `quantity` multiplied by the `acquisition_value`.
...
- Keep your tab names short. If you have many, they get hard to see.
