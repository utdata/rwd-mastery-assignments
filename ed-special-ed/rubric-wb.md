...
With this assignment, you'll use many of the **basic data journalism tasks** discussed earlier in the semester, including:

> NEEDS LINKS TO VIDEO EXPLAINERS

- Cleaning data
- Select & filter
- Joining files on a common record
